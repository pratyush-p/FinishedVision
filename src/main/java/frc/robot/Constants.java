...
public final class Constants 
{
    ...
    public static final int TRANSPORT_BUTTON = 3;
    public static final int PULLEY_BUTTON = 4;
    //public static final int SHOOTER_BUTTON = 11;
    public static final int TILT_BUTTON_UP = 8;
    public static final int TILT_BUTTON_DOWN = 7;
    ...
    public static final int TILT_AUTO_BUTTON = 2;
